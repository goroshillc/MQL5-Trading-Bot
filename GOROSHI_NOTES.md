...
```
Generic MQL5 bot template.
```

## How GOROSHI uses it

`Reference implementation for EA scaffolding.`
...
`Reference only.` -- e.g. "called from `goroshi-swarm/bin/worker.py`
